...
const Hero = () => {
  ...
  />
        ...
        <div className='col-span-2 px-5 my-auto'>
            ...
            <div className='my-8'> 
                <a href="/Tristan-Glenn-Bantigue-Resume.pdf" download="Tristan-Glenn-Bantigue-Resume.pdf" className="px-6 py-3 w-full rounded-xl border mr-4 border-gray-400 hover:bg-gradient-to-br from-blue-500 to-pink-500  text-white">
                Download Resume
                </a>
...
>>>>>>> 7701deff6f31bc3af9c2d63a0b1bce0ac41facd2
export default Hero