  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8'>
        ...
        <div className='col-span-2 px-5 my-auto'>
            ...
            <div className='my-8'> 
                <a href="/Tristan-Glenn-Bantigue-Resume.pdf" download="Tristan-Glenn-Bantigue-Resume.pdf" className="px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white">
                Download Resume
                </a>
